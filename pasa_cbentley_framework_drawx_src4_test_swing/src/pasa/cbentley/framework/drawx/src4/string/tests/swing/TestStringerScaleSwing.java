...
import pasa.cbentley.framework.drawx.src4.string.tests.TestStringerScale;
...
public class TestStringerScaleSwing extends TestStringerScale {

   public TestStringerScaleSwing() {
